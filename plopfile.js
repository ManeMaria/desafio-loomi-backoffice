...
const { createWebsocketSetupAction } = require('./plopfiles/plopfile-actions/create-websocket-setup-action.ts');
const { createWebsocketListenerAction } = require('./plopfiles/plopfile-actions/create-websocket-listener-action.ts');
...
module.exports = function (plop) {
  ...
  plop.setGenerator('[PLUG WEBSOCKETS]: Create setup for websockets as plug-and-play feature', {
    description: 'Plug and play websocket to the project',
    prompts: [],
    actions: createWebsocketSetupAction,
  });
  plop.setGenerator('[SOCKETS LISTENER]: Create an websocket listener feature', {
